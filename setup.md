...
Your MacBook must be running OS X El Capitan. This is a free upgrade from the App Store.
...
* Install XCode Command Line Tools
    ...
    1. Look for "Command Line Tools (OS X 10.11) for Xcode - Xcode 7.2" and download them.
